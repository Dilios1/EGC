...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        //ADITIONAL LIGHT
        private bool additionalLightOn;

        private float[] additionalLightAmbient = { 0.1f, 0.0f, 0.0f, 1.0f };
        private float[] additionalLightDiffuse = { 1.0f, 0.0f, 0.0f, 1.0f };
        private float[] additionalLightSpecular = { 0.1f, 0.0f, 0.0f, 1.0f };
        private float[] additionalLightPosition = { 0.0f, 0.0f, 5.0f, 1.0f };
        private System.Windows.Forms.TrackBar trackBarLightX;
        private System.Windows.Forms.NumericUpDown numericLightAmbient_Red;
        ...
        {
            additionalLightOn = !additionalLightOn;
            Console.WriteLine("additionalLightOn: " + additionalLightOn); // Mesaj de depanare
            GlControl1.Invalidate();
        }
        ...
        private void DrawAdditionalLight()
        {
            if (additionalLightOn)
            {
                GL.Light(LightName.Light1, LightParameter.Ambient, additionalLightAmbient);
                GL.Light(LightName.Light1, LightParameter.Diffuse, additionalLightDiffuse);
                GL.Light(LightName.Light1, LightParameter.Specular, additionalLightSpecular);
                GL.Light(LightName.Light1, LightParameter.Position, additionalLightPosition);
        ...
        private void trackBarLightX_Scroll(object sender, EventArgs e)
        {
            additionalLightPosition[0] = trackBarLightX.Value;
            glControl1.Invalidate();
        }

        private void numericLightAmbient_Red_ValueChanged(object sender, EventArgs e)
        {
            additionalLightAmbient[0] = (float)numericLightAmbient_Red.Value / 100;
            glControl1.Invalidate();
        }
