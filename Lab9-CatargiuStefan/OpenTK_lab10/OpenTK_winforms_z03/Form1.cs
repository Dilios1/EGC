...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private void btnTriangles1_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadTList();
        ...
        private void btnTriangles2_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            loadVertex();
            loadTList();
        ...
        // Desenează cubul - triangles - textura 1 - 50%.
        private void DeseneazaCubT_Tex5()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
